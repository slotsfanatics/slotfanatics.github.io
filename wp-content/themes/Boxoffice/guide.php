...
function t_guide() {
	...
	//add_submenu_page( 'theme_options.php', 'How to use the theme', 'Theme user guide', 8, 'user_guide', 't_guide_options' );
}
...
<div class="gblock">
  ...
  <h2>How to add featured thumbnail to posts?</h2>
	...
	<h2> How to create a Movie Review post</h2>
	<p><iframe src="http://www.screenr.com/embed/P5Rs" width="650" height="396" frameborder="0"></iframe></p>
